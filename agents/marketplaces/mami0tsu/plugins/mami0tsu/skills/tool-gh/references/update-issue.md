...
bash "<plugin-root>/skills/tool-gh/scripts/github-body-operation.sh" issue-update \
  --repo <host>/<owner>/<repo> --issue <number> --title '<title>'
```
...
```sh
gh issue edit <number> --repo <host>/<owner>/<repo> --add-assignee <login>
gh issue edit <number> --repo <host>/<owner>/<repo> --remove-assignee <login>
gh issue edit <number> --repo <host>/<owner>/<repo> --add-label '<label>'
gh issue edit <number> --repo <host>/<owner>/<repo> --remove-label '<label>'
```
